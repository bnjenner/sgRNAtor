...
$art -ss HS25 -i /restricted/projectnb/challenge2025/sgRNAtor/ardenix/syn_sgRNAs/syn_sgRNAs.fa -o /restricted/projectnb/challenge2025/Data/apl_simdata/ardenix_ART_illumina_HS25_100fc/ -l 150 -f 100 -p -m 500 -s 10 -sam 
#counter=$((counter + 1))
