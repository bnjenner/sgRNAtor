...
$art -ss HSXt -i /restricted/projectnb/challenge2025/sgRNAtor/ardenix/syn_sgRNAs/syn_reads/COV_multifastq.faa -o /restricted/projectnb/challenge2025/Data/apl_simdata/ART_sGENERATE_reads_illumina_100fc_75nt/sgen_100fc_75nt -l 75 -f 100 -p -m 500 -s 10 -sam 
#counter=$((counter + 1))
