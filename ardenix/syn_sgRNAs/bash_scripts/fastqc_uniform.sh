...
export fasts=/restricted/projectnb/challenge2025/Data/apl_simdata/uniform_illumina_weighted/sim_data
export qcout=/restricted/projectnb/challenge2025/Data/apl_simdata/QC
export outP=${qcout}/uniform_illumina_weighted

[[ -d ${outP} ]] || mkdir -p ${outP}

proj="uniform_illumina_weighted"
