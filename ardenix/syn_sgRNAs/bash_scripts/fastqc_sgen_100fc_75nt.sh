...
export fasts=/restricted/projectnb/challenge2025/Data/apl_simdata/ART_sGENERATE_reads_illumina_100fc_75nt
export qcout=/restricted/projectnb/challenge2025/Data/apl_simdata/QC
export outP=${qcout}/ART_sGENERATE_reads_illumina_100fc_75nt

[[ -d ${outP} ]] || mkdir -p ${outP}

proj="sgen_100fc_75nt"
